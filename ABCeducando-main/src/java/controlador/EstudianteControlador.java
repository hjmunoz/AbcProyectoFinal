    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      String opcion;        
        ...
        switch (opcion) {
            ...
            File arch = new File("E:\\TRIMESTRE VI\\PROYECTO FINAL ABCEDUCANDO\\ABCeducando-main\\web\\Doc\\documentos\\Documentos entregados\\"+nombreArchivo);
            FileOutputStream out = new FileOutputStream(arch);
            String rutaArchivo ="/Doc/documentos/Documentos entregados/"+nombreArchivo;
           ...
           if(estudianteDao.agregar()){
                ...
                request.getRequestDispatcher("actividadEntregada.jsp").forward(request, response);
