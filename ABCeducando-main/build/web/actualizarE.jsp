                                ...
                                <div class="card-body" style="border: solid 0px; padding: 20px; height: 550px;"> 
                                    ...
                                    <form class="" action="Usuario" method="post">    
                                        <div class="col-lg-6">
                                            ...
                                            <label style="border: solid 0px; width: 500px;" class="form-control">Tipo Documento</label>
                                            ...
                                            <input style="width: 500px;" class="form-control" type="password"  name="clave"  value="" required>
