                            ...
                            <div class="sparkline13-list">
                                <div class="sparkline13-hd">
                                    <ul id="myTabedu1" class="tab-review-design">
                                        <li class="active"><a href="">Calificar actividades</a></li>
                                    </ul>
                                </div>
                                           ...
                                           data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead style="font-size: 20px;">
                                                <tr>
                                                    ...
                                                    <th data-field="" data-editable="true">Estudiante</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle"><%=datosVO.getEstudianteId()%></td> 
                                                    ...
                                                    <td style="vertical-align: middle">
                                                        <form id="crudForm"  action="Docente" method="post">
                                                            ...
                                                            <select name="calificacion" id="cars" style="height: 35px">
                                                                <option>...</option>
                                                            ...
                                                            <button type="submit" class="btn btn-primary waves-effect waves-light" style="padding: 5px; border-radius: 5px;">Calificar</button>
                                                        </form>
                                                    </td>                                                                                                             
                                                </tr>   
                                                <%}%>
