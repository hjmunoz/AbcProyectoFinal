            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                        ...
                        <div class="about-caption">
                            <div class="single-features mb-30">
                                <div class="features-icon">
                                    <img src="assets-2/img/icon/about-icon1.svg" alt="">
                                </div>
                            ...
                            <div class="single-features mb-30">
                                <div class="features-icon">
                                    <img src="assets-2/img/icon/about-icon2.svg" alt="">
                                </div>
                                <div class="features-caption">
                            ...
                            <div class="single-features mb-30">
                                <div class="features-icon">
                                    <img src="assets-2/img/icon/about-icon3.svg" alt="">
                                </div>
                                <div class="features-caption">
                    ...
                    <div class="col-lg-7 col-md-12">
                        <!-- about-img -->
                        <div class="about-img ">
                            <img src="assets-2/img/gallery/about2.png" alt="" class="w-100">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="team-active">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="single-team mb-30 text-center">
                                <div class="team-img">
                                    <img src="assets-2/img/gallery/team1.png" alt="">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="single-team mb-30 text-center">
                                <div class="team-img">
                                    <img src="assets-2/img/gallery/team2.png" alt="">
                                    <div class="team-caption">
                                        <!-- Blog Social -->
                                        <div class="team-social">
                                            <ul>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="single-team mb-30 text-center">
                                <div class="team-img">
                                    <img src="assets-2/img/gallery/team3.png" alt="">
                                    <div class="team-caption">
                                        <!-- Blog Social -->
                                        <div class="team-social">
                                            <ul>
                            ...
                            <div class="single-testimonial text-center">
                                <div class="testimonial-caption ">
                                    <div class="testimonial-top-cap">
                                        <img src="assets-2/img/gallery/testimonial.png" alt="">
                                    ...
                                    <div class="testimonial-founder d-flex align-items-center justify-content-center">
                                        <div class="founder-img">
                                            <img src="assets-2/img/gallery/founder-img.svg" alt="">
                                        </div>
                    ...
                    <div class="col-xl-12">
                        <div class="instagram-active owl-carousel">
                            <div class="single-instagram">
                                <img src="assets-2/img/gallery/instra1.png" alt="">
                                <a href="#"><i class="ti-instagram"></i></a>
                            </div>
                            <div class="single-instagram">
                                <img src="assets-2/img/gallery/instra2.png" alt="">
                                <a href="#"><i class="ti-instagram"></i></a>
                            </div>
                            <div class="single-instagram">
                                <img src="assets-2/img/gallery/instra3.png" alt="">
                                <a href="#"><i class="ti-instagram"></i></a>
                            </div>
                            <div class="single-instagram">
                                <img src="assets-2/img/gallery/instra4.png" alt="">
                                <a href="#"><i class="ti-instagram"></i></a>
                            </div>
                            <div class="single-instagram">
                                <img src="assets-2/img/gallery/instra1.png" alt="">
